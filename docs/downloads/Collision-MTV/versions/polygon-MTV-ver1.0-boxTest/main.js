...
function main() {
    ...
    // shapes.push(new Box(new Vector(randomInt(0, width), randomInt(0, height)), 50, 30));
    shapes.push(new Box(new Vector(randomInt(0, width), randomInt(0, height)), 100, 100));
    shapes.push(new Box(new Vector(randomInt(0, width), randomInt(0, height)), 200, 100));
    // shapes.push(new Box(new Vector(randomInt(0, width), randomInt(0, height)), 40, 40));
    // shapes.push(new Polygon(new Vector(randomInt(0, width), randomInt(0, height)), polygon_data[1]));
